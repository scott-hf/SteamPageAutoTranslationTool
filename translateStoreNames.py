...
with open("source/appname_base.json", "r") as file:
...
for entry in data["entries"]:
    ...
    output_directory = f'./exports/export_{entry["appid"]}/appname'
    ...
    output_file = f'{output_directory}/appname_{entry["appid"]}_{entry["language"]}.json'
...
mainExportFileName = "temp/appname_translations_file_translated.json"
